...
class PinjamApiController extends Controller
{
    public function index()
    {
        ...
        return new PinjamResource(Pinjam::with(['kendaraan', 'borrowed_by', 'processed_by', 'driver', 'created_by'])->get());
    }
    ...
    public function show(Pinjam $pinjam)
    {
        ...
        return new PinjamResource($pinjam->load(['kendaraan', 'borrowed_by', 'processed_by', 'driver', 'created_by']));
    }
