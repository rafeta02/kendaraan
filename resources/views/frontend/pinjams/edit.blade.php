                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.pinjams.update", [$pinjam->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date-picker" type="text" name="date_start" id="date_start" value="{{ old('date_start', $pinjam->date_start) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date-picker" type="text" name="date_end" id="date_end" value="{{ old('date_end', $pinjam->date_end) }}" required>
